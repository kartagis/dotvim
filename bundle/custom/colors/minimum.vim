...
let s:colors = {}
let s:colors.black  = [['0', '59',  '#5f5f5f'], ['8',  '102', '#878787']]
let s:colors.red    = [['1', '131', '#af5f5f'], ['9',  '174', '#d78787']]
let s:colors.green  = [['2', '107', '#87af5f'], ['10', '150', '#afd787']]
let s:colors.yellow = [['3', '137', '#af875f'], ['11', '180', '#dfaf87']]
let s:colors.blue   = [['4', '67',  '#5f87af'], ['12', '110', '#87afd7']]
let s:colors.purple = [['5', '97',  '#875faf'], ['13', '140', '#af87d7']]
let s:colors.cyan   = [['6', '72',  '#5faf87'], ['14', '115', '#87d7af']]
let s:colors.white  = [['7', '251', '#afafaf'], ['15', '231', '#d7d7d7']]
let s:colors.bg     = [['NONE',  '16',  '#000000']]
let s:colors.fg     = [['NONE',  '188', '#dfdfdf']]
