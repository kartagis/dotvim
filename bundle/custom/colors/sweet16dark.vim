" sweet16dark.vim -- Vim color scheme.
" Author:      Romain Lafourcade (romainlafourcade@gmail.com)
" Description: A 'dark' colorscheme using exclusively the lower 16 colors of the xterm palette.
...
if &t_Co >= 256 || has('gui_running')
    ...
    hi Identifier ctermbg=NONE ctermfg=11 cterm=NONE guibg=NONE guifg=#ffff00 gui=NONE
    hi Ignore ctermbg=NONE ctermfg=NONE cterm=NONE guibg=NONE guifg=NONE gui=NONE
    hi PreProc ctermbg=NONE ctermfg=12 cterm=NONE guibg=NONE guifg=#0000ff gui=NONE
    hi Special ctermbg=NONE ctermfg=11 cterm=NONE guibg=NONE guifg=#ffff00 gui=NONE
    hi Statement ctermbg=NONE ctermfg=14 cterm=NONE guibg=NONE guifg=#00ffff gui=NONE
    ...
    hi CursorLine ctermbg=5 ctermfg=NONE cterm=NONE guibg=#800080 guifg=NONE gui=NONE
    hi CursorLineNr ctermbg=3 ctermfg=0 cterm=NONE guibg=#808000 guifg=#000000 gui=NONE
    ...
    hi Folded ctermbg=8 ctermfg=0 cterm=NONE guibg=#808080 guifg=#000000 gui=NONE
    hi WildMenu ctermbg=14 ctermfg=0 cterm=NONE guibg=#00ffff guifg=#000000 gui=NONE
...
elseif &t_Co == 8 || $TERM !~# '^linux' || &t_Co == 16
    ...
    hi CursorLineNr ctermbg=3 ctermfg=0 cterm=NONE
    ...
    hi Folded ctermbg=8 ctermfg=0 cterm=NONE
