...
let s:colors = [
      \ { name = "Black",  normal = ['0', '59',  '#5f5f5f'], bright = ['8',  '102', '#878787'] },
      \ { name = "Red",    normal = ['1', '131', '#af5f5f'], bright= ['9',  '174', '#d78787'] },
      \ { name = "Green",  normal = ['2', '107', '#87af5f'], bright= ['10', '150', '#afd787'] },
      \ { name = "Yellow", normal = ['3', '137', '#af875f'], bright= ['11', '180', '#dfaf87'] },
      \ { name = "Blue",   normal = ['4', '67',  '#5f87af'], bright= ['12', '110', '#87afd7'] },
      \ { name = "Purple", normal = ['5', '97',  '#875faf'], bright= ['13', '140', '#af87d7'] },
      \ { name = "Cyan",   normal = ['6', '72',  '#5faf87'], bright= ['14', '115', '#87d7af'] },
      \ { name = "White",  normal = ['7', '251', '#afafaf'], bright= ['15', '231', '#d7d7d7'] },
      \ { name = "NONE",   normal = ['NONE',  '16',  '#000000'] } ]

let s:hi = {}

let colors_name = 'minimum'

if &t_Co >= 256 || has('gui_running')
  " normal colors
  let s:hi.black     = " ctermfg=" . s:colors.black[0][1]  . " guifg=" . s:colors.black[0][2]
  let s:hi.on_black  = " ctermbg=" . s:colors.black[0][1]  . " guibg=" . s:colors.black[0][2]
  let s:hi.red       = " ctermfg=" . s:colors.red[0][1]    . " guifg=" . s:colors.red[0][2]
  let s:hi.on_red    = " ctermbg=" . s:colors.red[0][1]    . " guibg=" . s:colors.red[0][2]
  let s:hi.green     = " ctermfg=" . s:colors.green[0][1]  . " guifg=" . s:colors.green[0][2]
  let s:hi.on_green  = " ctermbg=" . s:colors.green[0][1]  . " guibg=" . s:colors.green[0][2]
  let s:hi.yellow    = " ctermfg=" . s:colors.yellow[0][1] . " guifg=" . s:colors.yellow[0][2]
  let s:hi.on_yellow = " ctermbg=" . s:colors.yellow[0][1] . " guibg=" . s:colors.yellow[0][2]
  let s:hi.blue      = " ctermfg=" . s:colors.blue[0][1]   . " guifg=" . s:colors.blue[0][2]
  let s:hi.on_blue   = " ctermbg=" . s:colors.blue[0][1]   . " guibg=" . s:colors.blue[0][2]
  let s:hi.purple    = " ctermfg=" . s:colors.purple[0][1] . " guifg=" . s:colors.purple[0][2]
  let s:hi.on_purple = " ctermbg=" . s:colors.purple[0][1] . " guibg=" . s:colors.purple[0][2]
  let s:hi.cyan      = " ctermfg=" . s:colors.cyan[0][1]   . " guifg=" . s:colors.cyan[0][2]
  let s:hi.on_cyan   = " ctermbg=" . s:colors.cyan[0][1]   . " guibg=" . s:colors.cyan[0][2]
  let s:hi.white     = " ctermfg=" . s:colors.white[0][1]  . " guifg=" . s:colors.white[0][2]
  let s:hi.on_white  = " ctermbg=" . s:colors.white[0][1]  . " guibg=" . s:colors.white[0][2]

  " bright colors
  let s:hi.br_black     = " ctermfg=" . s:colors.black[0][1]  . " guifg=" . s:colors.black[0][2]
  let s:hi.on_br_black  = " ctermbg=" . s:colors.black[0][1]  . " guibg=" . s:colors.black[0][2]
  let s:hi.br_red       = " ctermfg=" . s:colors.red[0][1]    . " guifg=" . s:colors.red[0][2]
  let s:hi.on_br_red    = " ctermbg=" . s:colors.red[0][1]    . " guibg=" . s:colors.red[0][2]
  let s:hi.br_green     = " ctermfg=" . s:colors.green[0][1]  . " guifg=" . s:colors.green[0][2]
  let s:hi.on_br_green  = " ctermbg=" . s:colors.green[0][1]  . " guibg=" . s:colors.green[0][2]
  let s:hi.br_yellow    = " ctermfg=" . s:colors.yellow[0][1] . " guifg=" . s:colors.yellow[0][2]
  let s:hi.on_br_yellow = " ctermbg=" . s:colors.yellow[0][1] . " guibg=" . s:colors.yellow[0][2]
  let s:hi.br_blue      = " ctermfg=" . s:colors.blue[0][1]   . " guifg=" . s:colors.blue[0][2]
  let s:hi.on_br_blue   = " ctermbg=" . s:colors.blue[0][1]   . " guibg=" . s:colors.blue[0][2]
  let s:hi.br_purple    = " ctermfg=" . s:colors.purple[0][1] . " guifg=" . s:colors.purple[0][2]
  let s:hi.on_br_purple = " ctermbg=" . s:colors.purple[0][1] . " guibg=" . s:colors.purple[0][2]
  let s:hi.br_cyan      = " ctermfg=" . s:colors.cyan[0][1]   . " guifg=" . s:colors.cyan[0][2]
  let s:hi.on_br_cyan   = " ctermbg=" . s:colors.cyan[0][1]   . " guibg=" . s:colors.cyan[0][2]
  let s:hi.br_white     = " ctermfg=" . s:colors.white[0][1]  . " guifg=" . s:colors.white[0][2]
  let s:hi.on_br_white  = " ctermbg=" . s:colors.white[0][1]  . " guibg=" . s:colors.white[0][2]

  let s:hi.fg     = " ctermfg=" . s:colors.fg[0][1]  . " guifg=" . s:colors.fg[0][2]
  let s:hi.on_fg  = " ctermbg=" . s:colors.fg[0][1]  . " guibg=" . s:colors.fg[0][2]
  let s:hi.bg     = " ctermbg=" . s:colors.bg[0][1]  . " guibg=" . s:colors.bg[0][2]
  let s:hi.on_bg  = " ctermbg=" . s:colors.bg[0][1]  . " guibg=" . s:colors.bg[0][2]

  let s:hi.none     = " ctermfg=NONE guifg=NONE"
  let s:hi.on_none  = " ctermbg=NONE guibg=NONE"


  " hi Normal           ctermbg=235  ctermfg=250  guibg=#262626 guifg=#bcbcbc cterm=NONE           gui=NONE
  " execute "hi Normal           ctermbg=" . s:colors.bg[0][1] . " ctermfg=" . s:colors.fg[0][1] . "guibg=" . s:colors.bg[0][2] . " guifg=" . s:colors.fg[0][2] . " cterm=NONE gui=NONE"
  execute "hi Normal" . s:hi.fg . s:hi.on_bg . " cterm=NONE gui=NONE"

  set background=dark

  execute "hi Comment"  . s:hi.black  . s:hi.on_none . " cterm=NONE gui=NONE"
  execute "hi Constant" . s:hi.br_red . s:hi.on_none . " cterm=NONE gui=NONE"
  execute "hi Error"    . s:hi.red    . s:hi.on_none . " cterm=reverse gui=reverse"
  ...
  execute "hi String"    . s:hi.purple . s:hi.on_none . " cterm=NONE gui=NONE"
  ...
  execute "hi CursorLine"    . s:hi.none . s:hi.on_black . " cterm=NONE gui=NONE"
