...
if &t_Co >= 256 || has('gui_running')
  hi Normal ctermbg=NONE ctermfg=252 cterm=NONE guibg=#262626 guifg=#d0d0d0 gui=NONE

  set background=dark

  hi Comment ctermbg=NONE ctermfg=240 cterm=NONE guibg=NONE guifg=#585858 gui=NONE
  hi Constant ctermbg=NONE ctermfg=252 cterm=NONE guibg=NONE guifg=#d0d0d0 gui=NONE
  hi Error ctermbg=NONE ctermfg=252 cterm=NONE guibg=NONE guifg=#d0d0d0 gui=NONE
  hi Identifier       ctermbg=NONE ctermfg=255  guibg=NONE    guifg=#eeeeee cterm=NONE           gui=NONE
