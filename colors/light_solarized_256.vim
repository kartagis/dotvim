...
SpecialKey     xxx term=bold cterm=bold ctermfg=244 ctermbg=187 guifg=Blue
NonText        xxx term=bold cterm=bold ctermfg=244 gui=bold guifg=Blue
Directory      xxx ctermfg=33 guifg=Blue
...
Search         xxx term=reverse cterm=reverse ctermfg=136 guibg=Yellow
MoreMsg        xxx ctermfg=33 gui=bold guifg=SeaGreen
ModeMsg        xxx ctermfg=33 gui=bold
LineNr         xxx ctermfg=245 ctermbg=187 guifg=Brown
CursorLineNr   xxx term=bold ctermfg=130 gui=bold guifg=Brown
Question       xxx term=bold cterm=bold ctermfg=37 gui=bold guifg=SeaGreen
StatusLine     xxx term=reverse cterm=reverse ctermfg=239 ctermbg=187 gui=bold,reverse
StatusLineNC   xxx term=reverse cterm=reverse ctermfg=244 ctermbg=187 gui=reverse
VertSplit      xxx ctermfg=244 ctermbg=244 gui=reverse
Title          xxx term=bold cterm=bold ctermfg=166 gui=bold guifg=Magenta
Visual         xxx term=reverse cterm=reverse ctermfg=245 ctermbg=230 guibg=LightGrey
VisualNOS      xxx term=reverse cterm=reverse ctermbg=187 gui=bold,underline
WarningMsg     xxx term=bold cterm=bold ctermfg=124 guifg=Red
WildMenu       xxx term=reverse cterm=reverse ctermfg=235 ctermbg=187 guifg=Black guibg=Yellow
Folded         xxx term=bold,underline cterm=bold,underline ctermfg=240 ctermbg=187 guifg=DarkBlue guibg=LightGrey
FoldColumn     xxx ctermfg=240 ctermbg=187 guifg=DarkBlue guibg=Grey
DiffAdd        xxx ctermfg=64 ctermbg=187 guibg=LightBlue
DiffChange     xxx ctermfg=136 ctermbg=187 guibg=LightMagenta
DiffDelete     xxx ctermfg=124 ctermbg=187 gui=bold guifg=Blue guibg=LightCyan
DiffText       xxx ctermfg=33 ctermbg=187 gui=bold guibg=Red
SignColumn     xxx ctermfg=240 ctermbg=248 guifg=DarkBlue guibg=Grey
Conceal        xxx ctermfg=33 guifg=LightGrey guibg=DarkGrey
...
SpellLocal     xxx term=undercurl cterm=undercurl gui=undercurl guisp=DarkCyan
Pmenu          xxx term=reverse cterm=reverse ctermfg=240 ctermbg=187 guibg=LightMagenta
PmenuSel       xxx term=reverse cterm=reverse ctermfg=245 ctermbg=235 guibg=Grey
PmenuSbar      xxx term=reverse cterm=reverse ctermfg=235 ctermbg=240 guibg=Grey
PmenuThumb     xxx term=reverse cterm=reverse ctermfg=240 ctermbg=230 guibg=Black
TabLine        xxx term=underline cterm=underline ctermfg=240 ctermbg=187 gui=underline guibg=LightGrey
TabLineSel     xxx term=underline,reverse cterm=underline,reverse ctermfg=245 ctermbg=235 gui=bold
TabLineFill    xxx term=underline cterm=underline ctermfg=240 ctermbg=187 gui=reverse
CursorColumn   xxx ctermbg=187 guibg=Grey90
CursorLine     xxx ctermbg=187 guibg=Grey90
ColorColumn    xxx ctermbg=187 guibg=LightRed
Cursor         xxx ctermfg=230 ctermbg=240 guifg=bg guibg=fg
lCursor        xxx guifg=bg guibg=fg
                   links to Cursor
MatchParen     xxx term=bold cterm=bold ctermfg=124 ctermbg=245 guibg=Cyan
Normal         xxx ctermfg=240 ctermbg=230
Comment        xxx ctermfg=245 guifg=Blue
Constant       xxx ctermfg=37 guifg=Magenta
Special        xxx ctermfg=124 guifg=SlateBlue
Identifier     xxx ctermfg=33 guifg=DarkCyan
Statement      xxx ctermfg=64 gui=bold guifg=Brown
PreProc        xxx ctermfg=166 guifg=Purple
Type           xxx ctermfg=136 gui=bold guifg=SeaGreen
Underlined     xxx ctermfg=61 gui=underline guifg=SlateBlue
Ignore         xxx guifg=bg
...
gitcommitComment xxx ctermfg=245
...
gitcommitOnBranch xxx term=bold cterm=bold ctermfg=245
...
gitcommitHeader xxx ctermfg=245
...
gitcommitFile  xxx term=bold cterm=bold ctermfg=240
...
htmlTagN       xxx term=bold cterm=bold ctermfg=239
htmlArg        xxx ctermfg=244
javaScript     xxx ctermfg=136
perlHereDoc    xxx ctermfg=239 ctermbg=230
perlVarPlain   xxx ctermfg=136 ctermbg=230
perlStatementFileDesc xxx ctermfg=37 ctermbg=230
texStatement   xxx ctermfg=37 ctermbg=230
texMathZoneX   xxx ctermfg=136 ctermbg=230
texMathMatcher xxx ctermfg=136 ctermbg=230
texRefLabel    xxx ctermfg=136 ctermbg=230
rubyDefine     xxx term=bold cterm=bold ctermfg=239 ctermbg=230
cPreCondit     xxx ctermfg=166
VarId          xxx ctermfg=33
ConId          xxx ctermfg=136
hsImport       xxx ctermfg=125
hsString       xxx ctermfg=244
...
pandocBlockQuoteLeader5 xxx ctermfg=240
pandocBlockQuoteLeader6 xxx ctermfg=245
...
pandocTableZebraLight xxx ctermfg=33 ctermbg=230
pandocTableZebraDark xxx ctermfg=33 ctermbg=187
...
pandocLinkDelim xxx ctermfg=245
...
pandocLinkURL  xxx term=underline cterm=underline ctermfg=244
pandocLinkTitle xxx term=underline cterm=underline ctermfg=244
pandocLinkTitleDelim xxx term=underline cterm=underline ctermfg=245
...
pandocStyleDelim xxx ctermfg=245
pandocEmphasis xxx ctermfg=240
pandocEmphasisNested xxx term=bold cterm=bold ctermfg=240
pandocStrongEmphasis xxx term=bold cterm=bold ctermfg=240
pandocStrongEmphasisNested xxx term=bold cterm=bold ctermfg=240
pandocStrongEmphasisEmphasis xxx term=bold cterm=bold ctermfg=240
pandocStrikeout xxx term=reverse cterm=reverse ctermfg=245
...
pandocMetadataDelim xxx ctermfg=245
